...
<head>
    ...
    <style>  
        ...
        body {
        margin: 0; 
        padding-bottom: 80px; /* Jarak antara konten dan footer */
    }
        footer {
            position: absolute;
            bottom: 0;
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="admin.php?page=user">Manajemen User</a></li> 
...
<!-- content end -->
    ...
    <div>
        ...
        ></a>
        <a href="https://wa.me/+6289674956010"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Muhammad Diva Irnanda &copy; 2023</div>
    </footer>
    <!-- footer end -->
    <script
